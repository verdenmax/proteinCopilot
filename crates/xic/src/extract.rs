...
pub(crate) fn compute_ion_metadata(
    ions: &[TargetIon],
    peptide: &str,
) -> Vec<crate::IonMetadataEntry> {
...
///
/// Unlike a full-file streaming scan over **every** spectrum, this function uses
/// [`SpectrumReader::list_scan_meta`] to obtain scan metadata
...
pub fn extract_xic_unified(
    ...
    let total_planned = planned_light_ms2.len() + planned_heavy_ms2.len() + planned_ms1.len();
    tracing::info!(
